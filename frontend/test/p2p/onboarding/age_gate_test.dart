...
void main() {
  ...
  group('§14.4 — Age gate onboarding flow', () {
    ...
    test('user aged 12 is blocked from creating an account', () {
      ...
      expect(
        result,
        equals(AgeGateResult.blocked),
        reason: 'under-13 user must be blocked (COPPA)',
      );
    });

    test(
      '"prefer not to say" maps to undisclosed (safe default = blocked)',
      () {
        ...
        expect(
          result,
          equals(AgeGateResult.undisclosed),
