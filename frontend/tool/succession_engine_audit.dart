...
String runSuccessionAudit(List<String> args) {
  ...
  lines.add(
    'Succession audit: baseline d${options.baselineDepth}/${options.baselineMs}ms '
  ...
  if (options.openingMoves.isNotEmpty) {
    ...
    for (final notation in options.openingMoves) {
      ...
      if (move == null) {
        throw ArgumentError('Illegal Succession opening move: $notation');
      }
