...
import 'classic.dart';
// import 'diamonds.dart'; // DISABLED MODE
import 'friendly_fire.dart';
import 'heir.dart';
import 'kings_battle.dart';
// import 'coyote.dart'; // DISABLED MODE
import 'mercenary.dart';
import 'save_the_queen.dart';
import 'succession.dart';
// import 'snare.dart'; // DISABLED MODE
// import 'secret_passage.dart'; // DISABLED MODE
import 'truce.dart';
...
class ModesCache {
  ...
  // static const Snare snare = Snare(); // DISABLED MODE
  static const Truce truce = Truce();
  // static const SecretPassage secretPassage = SecretPassage(); // DISABLED MODE
  ...
  // static const Coyote coyote = Coyote(); // DISABLED MODE
  // static const Diamonds diamonds = Diamonds(); // DISABLED MODE
...
class ModesAlias {
  const ModesAlias();
  // Snare get snare => ModesCache.snare; // DISABLED MODE
  Truce get truce => ModesCache.truce;
  // SecretPassage get secretPassage => ModesCache.secretPassage; // DISABLED MODE
  ...
  // Coyote get coyote => ModesCache.coyote; // DISABLED MODE
  // Diamonds get diamonds => ModesCache.diamonds; // DISABLED MODE
