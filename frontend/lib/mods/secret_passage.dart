...
/// Secret Passage Mod: Kings and rooks can swap positions when aligned
///
/// Rules:
...
class SecretPassage extends GameMod {
  @Deprecated(
    'Use the `mods.secretPassage` alias from mods_cache.dart instead of direct instantiation',
  )
  const SecretPassage();
