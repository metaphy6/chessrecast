// Allow the cache to use constructors, even though direct instantiation is discouraged.
// ignore_for_file: deprecated_member_use, deprecated_member_use_from_same_package
import 'classic.dart';
import 'friendlyfire.dart';
import 'heir.dart';
import 'kingsbattle.dart';
import 'mercenary.dart';
import 'savequeen.dart';
import 'succession.dart';
import 'truce.dart';

/// Centralized singleton cache for all mode ruleset instances.
///
/// IMPORTANT: Use the top-level `mods` alias (exported in `cache.dart`) to access these
