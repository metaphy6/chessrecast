...
/// Coyote Mod: Race your rook to the opponent's back rank!
///
/// WIN CONDITIONS:
...
class Coyote extends GameMod {
  @Deprecated(
    'Use the `mods.coyote` alias from mods_cache.dart instead of direct instantiation',
  )
  const Coyote();
  @override
  ...
  List<String>? getPromotionPieces(
    ...
    // Disable promotion to rook in Coyote Mod
