...
/// Snare Mod: Knights create entangle zones that trap enemy pieces
///
/// Rules:
...
class Snare extends GameMod {
  @Deprecated(
    'Use the `mods.snare` alias from mods_cache.dart instead of direct instantiation',
  )
  const Snare();

  /// Snare Mod: Gets the knights of the specified color
  ...
  /// Snare Mod: Override isKingInCheck - King cannot be in check if at least one knight is alive
  ...
  /// Snare Mod: Check if king is actually capturable (can be eaten by opponent)
  ...
  /// Snare Mod: Checks if two knights defend each other (creating an entangle zone)
  ...
  /// Snare Mod: Gets the entangle zone positions between two defending knights
  ...
  /// Snare Mod: Gets all entangled pieces for a given color
  ...
  /// Snare Mod: Checks if a piece is currently entangled
  ...
  /// Snare Mod: Gets the entangle zone positions that trap this piece
  ...
  /// Snare Mod: Checks if the king is entangled (instant mate condition)
  ...
  /// Snare Mod: Gets valid moves for an entangled piece
  ...
  /// Snare Mod: Checks if a move passes through an entangle zone
