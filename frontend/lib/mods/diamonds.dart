...
/// Diamonds Mod: Bishops move diagonally but capture in diamond patterns
///
/// Rules:
...
class Diamonds extends GameMod {
  @Deprecated(
    'Use the `mods.diamonds` alias from mods_cache.dart instead of direct instantiation',
  )
  const Diamonds();
  ...
  GameStatus? updateGameStatus(
    ...
    // Diamonds Mod uses standard chess rules for game status
    return null;
  }

  @override
  ChessBoard? handleSpecialMove(ChessBoard board, ChessMove move) {
    // No special move handling needed for Diamonds Mod
    return null;
  }
}
