"""
Export trained model to TFLite for Flutter integration
"""
import torch
...
def export_mercenary_model():
    ...
    print("=" * 80)
    print("EXPORT MERCENARY MODEL TO TFLITE")
    print("=" * 80)
    
    # Paths
    checkpoint_dir = Path('/workspace/checkpoints/mercenary')
    model_path = checkpoint_dir / 'mercenary_final.pth'
    output_path = Path('/workspace/models/mercenary.tflite')
