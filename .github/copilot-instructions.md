...
| **Chess work queue** | [`bots/queue.yaml`](../bots/queue.yaml), [`bots/baselines/`](../bots/baselines/) |
...
| `chess-mod-improver` | Autonomous chess mod improvement loop (audit gate, baseline, fix) | [`agents/chess-mod-improver.agent.md`](agents/chess-mod-improver.agent.md) |
| `p2p-roadmap-implementer` | Walk P2P roadmap leaf checkboxes end-to-end | [`agents/p2p-roadmap-implementer.agent.md`](agents/p2p-roadmap-implementer.agent.md) |
