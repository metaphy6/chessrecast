...
> **Companion:** [docs/P2P_ROADMAP.md](P2P_ROADMAP.md) §14, [docs/P2P_IDENTITY_POLICY.md](P2P_IDENTITY_POLICY.md).
...
This policy is versioned in the repository (`docs/P2P_TRUST_AND_SAFETY.md`). Material changes are noted in the release notes. The current version is v1, published with the Phase 14 implementation.
