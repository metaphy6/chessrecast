...
> **Roadmap reference:** [docs/P2P_ROADMAP.md](P2P_ROADMAP.md) § Phase 15.1.4  
> **Engagement scope:** [docs/P2P_AUDIT_SCOPE.md](P2P_AUDIT_SCOPE.md)
...
1. All Critical/High findings must be remediated and re-tested (per
   [docs/P2P_AUDIT_SCOPE.md](P2P_AUDIT_SCOPE.md) §4).
