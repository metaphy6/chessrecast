...
> **Companion:** [docs/P2P_PROTOCOL.md](P2P_PROTOCOL.md) §2, [docs/P2P_TRUST_AND_SAFETY.md](P2P_TRUST_AND_SAFETY.md) §2.
...
This policy is versioned in the repository (`docs/P2P_IDENTITY_POLICY.md`). Material changes are noted in the release notes. Current version: v1, published with Phase 14.
