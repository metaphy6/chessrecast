...
|---|---|---|
| [`code/`](code/) | Architecture, modules, APIs, engine notes. | Devs joining the codebase. |
| [`project/`](project/) | Charter, decision log, engine rules, glossary. | New contributors + agents. |
...
| [`p2p/`](p2p/) | All 25 P2P-specific documents (protocol, ops, privacy, security). | P2P devs + ops. |
...
| [`legal/`](legal/) | Privacy policy and data residency. | Legal + ops. |
| [`game/`](game/) | Game rules, draw rules, mod documentation. | Game contributors. |
| [`coding/`](coding/) | AI-assisted implementation notes and proposals. | Devs. |
