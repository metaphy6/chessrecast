...
rules belong in docs/project/ENGINE_RULES.md or .github/copilot-instructions.md,
not here.
...
- `docs/project/ENGINE_RULES.md` — chess-engine quality rules, per-mod isolation,
  audit gate procedure, and vigilance protocol.
- `bots/queue.yaml` — autonomous-loop work queue; `bots/baselines/` — test baselines;
  `bots/openings/` — opening book CSVs.
...
[`docs/project/ENGINE_RULES.md`](docs/project/ENGINE_RULES.md) quality rules
